...
export default function Legal() {
  ...
  return (
    <div className="container mt-3">
      ...
      <div
        class="accordion my-3 rounded"
        id="accordionExample"
        style={{ "--bs-accordion-active-color": "#0d6efd" }}
      >
            ...
            <div class="accordion-body">
              ...
              <address>
                <p>
                  ...
                  <br></br>69009 Lyon, France
                </p>
                <p>
                  <FontAwesomeIcon icon={faMobileScreenButton} />
                  <a href="tel:0620304050" style={{ color: "#0d6efd" }}>
                    {" "}
                    06 20 30 40 50
                  </a>
                </p>
            ...
            <div class="accordion-body">
              ...
              <address>
                ...
                <p>
                  ...
                  <a href="www-alwaysdata.com" style={{ color: "#0d6efd" }}>
                    {" "}
                    www-alwaysdata.com
                  </a>
                </p>
